...
- [Geospatial Data: A Guide](#geospatial-data-a-guide)
  ...
  - [3. Projecting and Transforming Geometries](#3-projecting-and-transforming-geometries)
    ...
    - [3.3 Overlaying Spatial Datasets](#33-overlaying-spatial-datasets)
      - [Example 1: Intersection Overlay in San Sebastian](#example-1-intersection-overlay-in-san-sebastian)
      - [Example 2: Intersection Inspection](#example-2-intersection-inspection)
  - [4. Case Study: Artisanal Mining Sites](#4-case-study-artisanal-mining-sites)
    - [4.1 File Formats](#41-file-formats)
    - [4.2 Explore the Dataset](#42-explore-the-dataset)
    - [4.3 Additional Spatial Operations: Unary Union and Buffer](#43-additional-spatial-operations-unary-union-and-buffer)
      - [Example 1: National Park Area and Mines in 50 km around City of Goma](#example-1-national-park-area-and-mines-in-50-km-around-city-of-goma)
      - [Example 2: Mining Sites in National Parks](#example-2-mining-sites-in-national-parks)
    - [4.4 Custom Spatial Operations](#44-custom-spatial-operations)
      - [Example 1: Distance from Parks to Mines](#example-1-distance-from-parks-to-mines)
      - [Example 2: Closest National Park from Each Mine](#example-2-closest-national-park-from-each-mine)
    - [4.5 Working with Raster Data](#45-working-with-raster-data)
      - [Example 1: Visualize Raster Images + Vector Geometries](#example-1-visualize-raster-images--vector-geometries)
      - [Example 2: Extract Information from Raster](#example-2-extract-information-from-raster)
